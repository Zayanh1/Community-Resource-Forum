      ...
      <div className="space-y-3 text-gray-600">
        ...
        <div className="mt-4 border-t border-gray-200 pt-3">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-gray-100 px-2.5 py-1.5 text-xs text-gray-700 hover:bg-gray-200 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-none"
          >
            Export
            <PiArrowSquareOut />
          </button>
